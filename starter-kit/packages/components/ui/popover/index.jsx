...
const Popover = React.forwardRef(({ className, size = 'md', ...props }, ref) => (<UIPopover ref={ref} {...props} 
// @ts-ignore
className={popoverStyle({ size, class: className })} context={{ size }} pointerEvents="box-none"/>));
const PopoverArrow = React.forwardRef(({ className, ...props }, ref) => (<UIPopover.Arrow ref={ref} transition={{
        type: 'spring',
        damping: 18,
        stiffness: 250,
        mass: 0.9,
    ...
    }} {...props} className={popoverArrowStyle({ class: className })}/>));
...
const PopoverBody = React.forwardRef(({ className, ...props }, ref) => (<UIPopover.Body ref={ref} {...props} className={popoverBodyStyle({
        class: className,
    })}/>));
const PopoverCloseButton = React.forwardRef(({ className, ...props }, ref) => (<UIPopover.CloseButton ref={ref} {...props} className={popoverCloseButtonStyle({
        class: className,
    })}/>));
...
const PopoverFooter = React.forwardRef(({ className, ...props }, ref) => (<UIPopover.Footer ref={ref} {...props} className={popoverFooterStyle({
        class: className,
    })}/>));
const PopoverHeader = React.forwardRef(({ className, ...props }, ref) => (<UIPopover.Header ref={ref} {...props} className={popoverHeaderStyle({
        class: className,
    })}/>));
