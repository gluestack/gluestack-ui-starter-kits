...
const AccordionIcon = React.forwardRef(({ size, className, color = "gray", ...props }, ref) => {
    const { size: parentSize } = useStyleContext(SCOPE);
    if (typeof size === "number") {
        return (<UIAccordion.Icon ref={ref} {...props} color={color} className={accordionIconStyle({ class: className })} size={size}/>);
    }
    else if ((props.height !== undefined || props.width !== undefined) &&
        size === undefined) {
        return (<UIAccordion.Icon ref={ref} {...props} color={color} className={accordionIconStyle({ class: className })}/>);
    }
    return (<UIAccordion.Icon ref={ref} color={color} {...props} className={accordionIconStyle({
            size,
            class: className,
