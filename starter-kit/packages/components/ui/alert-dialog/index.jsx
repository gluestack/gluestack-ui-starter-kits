...
const AlertDialogContent = React.forwardRef(({ className, size, ...props }, ref) => {
    ...
    return (<UIAccessibleAlertDialog.Content pointerEvents="auto" ref={ref} initial={{
            scale: 0.9,
            opacity: 0,
        }} animate={{
            scale: 1,
        ...
        }} {...props} className={alertDialogContentStyle({
            parentVariants: {
                size: parentSize,
            },
            size,
...
const AlertDialogCloseButton = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIAccessibleAlertDialog.CloseButton ref={ref} {...props} className={alertDialogCloseButtonStyle({
            class: className,
        })}/>);
});
const AlertDialogHeader = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIAccessibleAlertDialog.Header ref={ref} {...props} className={alertDialogHeaderStyle({
            class: className,
        })}/>);
});
const AlertDialogFooter = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIAccessibleAlertDialog.Footer ref={ref} {...props} className={alertDialogFooterStyle({
            class: className,
        })}/>);
});
const AlertDialogBody = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIAccessibleAlertDialog.Body ref={ref} {...props} className={alertDialogBodyStyle({
            class: className,
        })}/>);
});
const AlertDialogBackdrop = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIAccessibleAlertDialog.Backdrop ref={ref} initial={{
            opacity: 0,
        }} animate={{
            opacity: 0.5,
        }} exit={{
        ...
        }} {...props} className={alertDialogBackdropStyle({
            class: className,
        })}/>);
});
