export declare const hstackStyle: import("@gluestack-ui/nativewind-utils/types").TVReturnType<{
    space: {
        xs: string;
        sm: string;
        md: string;
...
}), undefined, "flex-row " | "flex-row flex relative z-0 box-border border-0 list-none min-w-0 min-h-0 bg-transparent items-stretch m-0 p-0 text-decoration-none", import("tailwind-variants/dist/config").TVConfig<{
    space: {
        xs: string;
        sm: string;
        md: string;
