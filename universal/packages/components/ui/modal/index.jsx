...
//@ts-ignore
{ className, size = 'md', ...props }, ref) => (<UIModal ref={ref} {...props} pointerEvents="box-none" className={modalStyle({ size, class: className })} context={{ size }}/>));
const ModalBackdrop = React.forwardRef(({ className, ...props }, ref) => {
    return (<UIModal.Backdrop ref={ref} initial={{
            opacity: 0,
        }} animate={{
            opacity: 0.5,
        }} exit={{
...
const ModalContent = React.forwardRef(({ className, size, ...props }, ref) => {
    ...
    return (<UIModal.Content ref={ref} initial={{
            opacity: 0,
            scale: 0.9,
        }} animate={{
            opacity: 1,
...
const ModalHeader = React.forwardRef(({ className, ...props }, ref) => (<UIModal.Header ref={ref} {...props} className={modalHeaderStyle({
        class: className,
    })}/>));
const ModalBody = React.forwardRef(({ className, ...props }, ref) => (<UIModal.Body ref={ref} {...props} className={modalBodyStyle({
        class: className,
    })}/>));
const ModalFooter = React.forwardRef(({ className, ...props }, ref) => (<UIModal.Footer ref={ref} {...props} className={modalFooterStyle({
        class: className,
    })}/>));
const ModalCloseButton = React.forwardRef(({ className, ...props }, ref) => (<UIModal.CloseButton ref={ref} {...props} className={modalCloseButtonStyle({
        class: className,
    })}/>));
