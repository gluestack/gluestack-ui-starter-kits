...
export function Header(props: HeaderProps) {
  return (
    <Box className="px-8 py-3 border-b bg-background-0 border-background-100 ">
          ...
          <HStack className="items-center" space="md">
            <Pressable>
              <Image
                ...
                // }
                source={require("../../../../assets/Menu_light.svg")}
                aspectRatio="203/24"
                size="2xs"
                alt="gluestack-ui"
              />
            ...
            <Image
              ...
              // }
              size="2xs"
              source={require("../../../../assets/gluestackUiPro_light.svg")}
              alt="gluestack-ui"
            />
          </HStack>
          ...
          <HStack className="mb-4 items-center" space="md">
            {props.displayBackIcon ? (
              <Pressable>
                <Icon
                  as={ArrowLeftIcon}
                  className="pt-0.5 stroke-typography-800 "
                />
              </Pressable>
            ) : null}
            <Box>
...
export function MobileHeader(props: MobileHeaderProps) {
  return (
    <Box className="px-1 py-4  bg-primary-500 border-background-200">
      <HStack space="sm">
        <HStack
            ...
            <HStack className="items-center" space="xs">
              {props.backButton && (
                <Icon
                  as={ArrowLeftIcon}
                  size="md"
                  className="m-2 stroke-typography-50 "
                />
              )}
              <VStack>
