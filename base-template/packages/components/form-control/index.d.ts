...
export declare const UIFormControl: import("@gluestack-ui/form-control/lib/typescript/types").IFormControlComponentType<import("react-native").ViewProps & {
    context?: any;
} & React.RefAttributes<unknown>, import("react-native").ViewProps, import("react-native").TextProps, Omit<any, "ref"> & React.RefAttributes<unknown>, import("react-native").ViewProps, import("react-native").TextProps, any, import("react-native").ViewProps, import("react-native").TextProps>;
...
declare const FormControl: {
    ({ className, size, ...props }: {
        ...
        context?: any;
    } & React.RefAttributes<unknown> & import("@gluestack-ui/form-control/lib/typescript/types").InterfaceFormControlProps & VariantProps<import("@gluestack-ui/nativewind-utils/types").TVReturnType<{
        size: {
            sm: string;
            md: string;
            lg: string;
...
declare const FormControlErrorText: {
    ({ className, size, ...props }: {
        className?: string | undefined;
...
declare const FormControlErrorIcon: {
    ({ className, size, color, ...props }: {
        className?: any;
        as?: any;
...
declare const FormControlLabelText: {
    ({ className, size, ...props }: {
        className?: string | undefined;
    } & import("react-native").TextProps & VariantProps<import("@gluestack-ui/nativewind-utils/types").TVReturnType<{
        isTruncated: {
...
declare const FormControlHelperText: {
    ({ className, size, ...props }: {
        className?: string | undefined;
    } & import("react-native").TextProps & VariantProps<import("@gluestack-ui/nativewind-utils/types").TVReturnType<{
        isTruncated: {
