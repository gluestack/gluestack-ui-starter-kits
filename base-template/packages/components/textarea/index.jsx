...
const Textarea = React.forwardRef(({ className, variant = 'default', size = 'md', ...props }, ref) => {
...
const TextareaInput = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (<UITextarea.Input ref={ref} {...props} className={textareaInputStyle({
            parentVariants: {
                size: parentSize,
            },
            class: className,
