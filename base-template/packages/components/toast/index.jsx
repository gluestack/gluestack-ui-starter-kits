...
export const Toast = React.forwardRef(({ className, variant, action, ...props }, ref) => {
    return (<UIToast ref={ref} {...props} className={toastStyle({ variant, action, class: className })}/>);
});
export const ToastTitle = React.forwardRef(({ className, size = 'md', ...props }, ref) => {
    return (<UIToast.Title ref={ref} {...props} className={toastTitleStyle({
            size,
            class: className,
        })}/>);
});
export const ToastDescription = React.forwardRef(({ className, size, ...props }, ref) => {
    return (<UIToast.Description ref={ref} {...props} className={toastDescriptionStyle({
            size,
            class: className,
        })}/>);
});
