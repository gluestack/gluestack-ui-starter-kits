...
const Svg = ({ style, className, ...props }) => {
...
const createIconUI = ({ ...props }) => {
    ...
    return React.forwardRef(({ className, size, ...props }, ref) => {
        return (<UIIcon ref={ref} {...props} className={iconStyle({ size, class: className })}/>);
    });
};
...
const ArrowUpIcon = createIcon({
    ...
    path: (<>
      ...
      <path d="M5 12L12 5L19 12" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
const ArrowDownIcon = createIcon({
    ...
    path: (<>
      <path d="M12 5V19" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M19 12L12 19L5 12" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const BellIcon = createIcon({
    ...
    path: (<>
      ...
      <path d="M13.73 21C13.5542 21.3031 13.3018 21.5547 12.9982 21.7295C12.6946 21.9044 12.3504 21.9965 12 21.9965C11.6496 21.9965 11.3054 21.9044 11.0018 21.7295C10.6982 21.5547 10.4458 21.3031 10.27 21" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const CalendarDaysIcon = createIcon({
    ...
    path: (<>
      ...
      <path d="M8 14H8.01" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M12 14H12.01" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M16 14H16.01" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M8 18H8.01" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M12 18H12.01" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M16 18H16.01" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const ChevronsRightIcon = createIcon({
    ...
    viewBox: "0 0 24 24",
    path: (<>
      <path d="M13 17L18 12L13 7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M6 17L11 12L6 7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
const ChevronsUpDownIcon = createIcon({
    ...
    path: (<>
      ...
      <path d="M7 9L12 4L17 9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const EyeOffIcon = createIcon({
    ...
    path: (<>
      ...
      <path d="M6.61 6.61C4.62125 7.96462 3.02987 9.82526 2 12C2 12 5 19 12 19C13.9159 19.0051 15.7908 18.4451 17.39 17.39" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
const FavouriteIcon = createIcon({
    ...
    viewBox: "0 0 24 24",
    path: (<>
      <path d="M20.42 4.58C19.9183 4.07658 19.3222 3.67714 18.6658 3.40459C18.0094 3.13204 17.3057 2.99174 16.595 2.99174C15.8843 2.99174 15.1806 3.13204 14.5242 3.40459C13.8678 3.67714 13.2717 4.07658 12.77 4.58L12 5.36L11.23 4.58C10.7283 4.07658 10.1322 3.67714 9.47582 3.40459C8.81944 3.13204 8.11571 2.99174 7.40499 2.99174C6.69428 2.99174 5.99055 3.13204 5.33417 3.40459C4.67779 3.67714 4.08167 4.07658 3.57999 4.58C1.45999 6.7 1.32999 10.28 3.99999 13L12 21L20 13C22.67 10.28 22.54 6.7 20.42 4.58Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const GripVerticalIcon = createIcon({
    ...
    viewBox: "0 0 24 24",
    path: (<>
      <path d="M9 13C9.55228 13 10 12.5523 10 12C10 11.4477 9.55228 11 9 11C8.44772 11 8 11.4477 8 12C8 12.5523 8.44772 13 9 13Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M9 6C9.55228 6 10 5.55228 10 5C10 4.44772 9.55228 4 9 4C8.44772 4 8 4.44772 8 5C8 5.55228 8.44772 6 9 6Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M9 20C9.55228 20 10 19.5523 10 19C10 18.4477 9.55228 18 9 18C8.44772 18 8 18.4477 8 19C8 19.5523 8.44772 20 9 20Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M15 13C15.5523 13 16 12.5523 16 12C16 11.4477 15.5523 11 15 11C14.4477 11 14 11.4477 14 12C14 12.5523 14.4477 13 15 13Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M15 6C15.5523 6 16 5.55228 16 5C16 4.44772 15.5523 4 15 4C14.4477 4 14 4.44772 14 5C14 5.55228 14.4477 6 15 6Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M15 20C15.5523 20 16 19.5523 16 19C16 18.4477 15.5523 18 15 18C14.4477 18 14 18.4477 14 19C14 19.5523 14.4477 20 15 20Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const HelpCircleIcon = createIcon({
    ...
    path: (<>
      <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M9.09 9.00001C9.3251 8.33167 9.78915 7.76811 10.4 7.40914C11.0108 7.05016 11.7289 6.91894 12.4272 7.03872C13.1255 7.15849 13.7588 7.52153 14.2151 8.06353C14.6713 8.60554 14.9211 9.29153 14.92 10C14.92 12 11.92 13 11.92 13" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
const LinkIcon = createIcon({
    ...
    viewBox: "0 0 24 24",
    path: (<>
      <path d="M10 13C10.4295 13.5741 10.9774 14.0492 11.6066 14.3929C12.2357 14.7367 12.9315 14.9411 13.6467 14.9923C14.3618 15.0435 15.0796 14.9404 15.7513 14.6898C16.4231 14.4392 17.0331 14.0471 17.54 13.54L20.54 10.54C21.4508 9.59699 21.9548 8.33397 21.9434 7.02299C21.932 5.71201 21.4061 4.45794 20.4791 3.5309C19.5521 2.60386 18.298 2.07802 16.987 2.06663C15.676 2.05523 14.413 2.55921 13.47 3.47L11.75 5.18" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
const MailIcon = createIcon({
    ...
    path: (<>
      ...
      <path d="M22 7L13.03 12.7C12.7213 12.8934 12.3643 12.996 12 12.996C11.6357 12.996 11.2787 12.8934 10.97 12.7L2 7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const MenuIcon = createIcon({
    ...
    path: (<>
      ...
      <path d="M4 6H20" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M4 18H20" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const RepeatIcon = createIcon({
    ...
    viewBox: "0 0 24 24",
    path: (<>
      <path d="M17 2L21 6L17 10" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M3 11V10C3 8.93913 3.42143 7.92172 4.17157 7.17157C4.92172 6.42143 5.93913 6 7 6H21" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M7 22L3 18L7 14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M21 13V14C21 15.0609 20.5786 16.0783 19.8284 16.8284C19.0783 17.5786 18.0609 18 17 18H3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const Repeat1Icon = createIcon({
    ...
    path: (<>
      ...
      <path d="M7 22L3 18L7 14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M21 13V14C21 15.0609 20.5786 16.0783 19.8284 16.8284C19.0783 17.5786 18.0609 18 17 18H3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M11 10H12V14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const SettingsIcon = createIcon({
    ...
    viewBox: "0 0 24 24",
    path: (<>
      <path d="M12.22 2H11.78C11.2496 2 10.7409 2.21071 10.3658 2.58579C9.99072 2.96086 9.78 3.46957 9.78 4V4.18C9.77964 4.53073 9.68706 4.87519 9.51154 5.17884C9.33602 5.48248 9.08374 5.73464 8.78 5.91L8.35 6.16C8.04596 6.33554 7.70108 6.42795 7.35 6.42795C6.99893 6.42795 6.65404 6.33554 6.35 6.16L6.2 6.08C5.74107 5.81526 5.19584 5.74344 4.684 5.88031C4.17217 6.01717 3.73555 6.35154 3.47 6.81L3.25 7.19C2.98526 7.64893 2.91345 8.19416 3.05031 8.706C3.18717 9.21783 3.52154 9.65445 3.98 9.92L4.13 10.02C4.43228 10.1945 4.68362 10.4451 4.85905 10.7468C5.03448 11.0486 5.1279 11.391 5.13 11.74V12.25C5.1314 12.6024 5.03965 12.949 4.86405 13.2545C4.68844 13.5601 4.43521 13.8138 4.13 13.99L3.98 14.08C3.52154 14.3456 3.18717 14.7822 3.05031 15.294C2.91345 15.8058 2.98526 16.3511 3.25 16.81L3.47 17.19C3.73555 17.6485 4.17217 17.9828 4.684 18.1197C5.19584 18.2566 5.74107 18.1847 6.2 17.92L6.35 17.84C6.65404 17.6645 6.99893 17.5721 7.35 17.5721C7.70108 17.5721 8.04596 17.6645 8.35 17.84L8.78 18.09C9.08374 18.2654 9.33602 18.5175 9.51154 18.8212C9.68706 19.1248 9.77964 19.4693 9.78 19.82V20C9.78 20.5304 9.99072 21.0391 10.3658 21.4142C10.7409 21.7893 11.2496 22 11.78 22H12.22C12.7504 22 13.2591 21.7893 13.6342 21.4142C14.0093 21.0391 14.22 20.5304 14.22 20V19.82C14.2204 19.4693 14.3129 19.1248 14.4885 18.8212C14.664 18.5175 14.9163 18.2654 15.22 18.09L15.65 17.84C15.954 17.6645 16.2989 17.5721 16.65 17.5721C17.0011 17.5721 17.346 17.6645 17.65 17.84L17.8 17.92C18.2589 18.1847 18.8042 18.2566 19.316 18.1197C19.8278 17.9828 20.2645 17.6485 20.53 17.19L20.75 16.8C21.0147 16.3411 21.0866 15.7958 20.9497 15.284C20.8128 14.7722 20.4785 14.3356 20.02 14.07L19.87 13.99C19.5648 13.8138 19.3116 13.5601 19.136 13.2545C18.9604 12.949 18.8686 12.6024 18.87 12.25V11.75C18.8686 11.3976 18.9604 11.051 19.136 10.7455C19.3116 10.4399 19.5648 10.1862 19.87 10.01L20.02 9.92C20.4785 9.65445 20.8128 9.21783 20.9497 8.706C21.0866 8.19416 21.0147 7.64893 20.75 7.19L20.53 6.81C20.2645 6.35154 19.8278 6.01717 19.316 5.88031C18.8042 5.74344 18.2589 5.81526 17.8 6.08L17.65 6.16C17.346 6.33554 17.0011 6.42795 16.65 6.42795C16.2989 6.42795 15.954 6.33554 15.65 6.16L15.22 5.91C14.9163 5.73464 14.664 5.48248 14.4885 5.17884C14.3129 4.87519 14.2204 4.53073 14.22 4.18V4C14.22 3.46957 14.0093 2.96086 13.6342 2.58579C13.2591 2.21071 12.7504 2 12.22 2V2Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const SlashIcon = createIcon({
    ...
    path: (<>
      <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M4.92999 4.92999L19.07 19.07" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const SunIcon = createIcon({
    ...
    path: (<>
      ...
      <path d="M4.92999 4.93L6.33999 6.34" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M17.66 17.66L19.07 19.07" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <path d="M6.33999 17.66L4.92999 19.07" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M19.07 4.93L17.66 6.34" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const ThreeDotsIcon = createIcon({
    ...
    path: (<>
      ...
      <path d="M5 13C5.55228 13 6 12.5523 6 12C6 11.4477 5.55228 11 5 11C4.44771 11 4 11.4477 4 12C4 12.5523 4.44771 13 5 13Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
...
const UnlockIcon = createIcon({
    ...
    path: (<>
      <path d="M19 11H5C3.89543 11 3 11.8954 3 13V20C3 21.1046 3.89543 22 5 22H19C20.1046 22 21 21.1046 21 20V13C21 11.8954 20.1046 11 19 11Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M7 11V7C6.99876 5.76005 7.45828 4.56387 8.28938 3.64367C9.12047 2.72347 10.2638 2.1449 11.4975 2.02029C12.7312 1.89568 13.9671 2.2339 14.9655 2.96931C15.9638 3.70472 16.6533 4.78485 16.9 6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </>),
});
